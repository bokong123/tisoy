			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				...
				<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
					<form action="" method="post" name="form1" id="form1" enctype="multipart/form-data" >
						...
						echo "<br><br><p>Product Name: <input name='product_name' type='input'  required/></p>";
						echo "<br><p>Price: <input name='product_price' type='input'  required/></p>";
						echo " <br><input name='saveproduct' type='Submit' value='Save Product'/>";
						



						if (isset($_POST["saveproduct"])) {
							$sql = $connect->query("Insert Into product (product_name,product_price)
								VALUES('".$_POST['product_name']."', 
								".$_POST['product_price'].")");
							if($sql)
							{
								echo '<script>alert("Product record has been successfully saved...")</script>';
